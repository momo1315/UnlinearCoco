...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Unlinear Coco', // 您的昵称 例如 tangly1024
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '951018066@qq.com', // 邮箱地址 例如mail@tangly1024.com
